...
if __name__ == "__main__":
    ...
    c1.content = (
        ...
        """<p>Introduction paragraph <a class="test">with a link</a> where i explain what is """
        """happening.</p></body></html>"""
    )

    # about chapter
    c2 = epub.EpubHtml(title="About this book", file_name="about.xhtml")
    c2.content = (
        """<html><head></head><body><h1>About this book</h1>"""
        """<p>Helou, this is my book! There are many books, but this one is mine.</p></body></html>"""
    )
